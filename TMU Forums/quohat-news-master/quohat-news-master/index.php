...
<html> 
  ...
  <div class="card">
    ...
    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
 	...
 	<!--BrandsVN-->
        <ul class="list-group">
        <li class="list-group-item active">Những tin quan trọng nhất của <a style="color : #fff;" href="https://www.brandsvietnam.com/" target="_blank" >Brand VN</a></li>
       <?php
            $html_BrandsVN =  file_get_html("https://www.brandsvietnam.com/");
            $list_BrandsVN = $html_BrandsVN->find("article[class=media] a[class=h5]");
            $top_BrandsVN_left = $html_BrandsVN->find("div[class=col-sm-7] div[class=m-t-sm m-b-sm] a[class=h3 block] ",0);
	    $title = $html_BrandsVN->find("div[class=col-sm-7] div[class=m-t-sm m-b-sm] a[class=h3 block]",0);
            $toptitle_BrandsVN_left= $title ->innertext;
	    $href = $html_BrandsVN->find("div[class=col-sm-7] a",0);
            $toplink_BrandsVN_left = "https://www.brandsvietnam.com/".$top_BrandsVN_left->href;
	    $i=0;
            echo "<li class='list-group-item'  style='font-size:15px;'> <a href='$toplink_BrandsVN_left' onclick='doalert(this); return false;'>● ".$toptitle_BrandsVN_left."</a></li>";
            foreach ($list_BrandsVN as $menu_BrandsVN) {
  	 	if($i==16) break;
                $title_BrandsVN = $menu_BrandsVN->innertext;
                $link_BrandsVN = "https://www.brandsvietnam.com/".$menu_BrandsVN->href;
                echo "<li class='list-group-item'  style='font-size:15px;'> <a href='$link_BrandsVN' onclick='doalert(this); return false;'>● ".$title_BrandsVN."</a></li>";
		$i++;
            }
        ?>
                                ...
                                switch ($host) {
                                    ...
                                    case 'cafebiz.vn':
                                        ...
                                        $title = str_replace('\\','',$title);
                                         ...
                                         echo $text;
                                        break;
				    case 'www.brandsvietnam.com':
                                        $html = file_get_html(str_replace("beta.","",$url));
                                        $title = $html->find("meta[property=og:title]", 0)->content;
                                        $img = $html->find("meta[property=og:image]",0)->content;
                                        $des = $html->find("meta[name=description]",0)->content;
                                        $des1 = $html->find("div[class=reading-content] p span[class=lead]" ,0)->innertext;
                                        $time = $html->find("div[class=col-xs-4 col-sm-12]",0)->innertext;
                                        $title = str_replace('\\','',$title);
                                         require "sor.php";
                                         echo $text;
                                        break;
